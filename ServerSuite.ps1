    ...
    { 
       ...
       1{ #************************** Remote Desktop Service Restart *****************************************#
           ...
           [System.Reflection.Assembly]::LoadWithPartialName('Microsoft.VisualBasic') | Out-Null 
            $pcname = [Microsoft.VisualBasic.Interaction]::InputBox("Enter the server name like AZVM01")
...
"
 ...
 Copied file(s) from $Source to $Destination", "OKOnly,SystemModal,Information", "Success")
             ...
             6{    #************************** Check and disconnect Logon Session *****************************************#
                    ...
                    Write-Host
                    [System.Reflection.Assembly]::LoadWithPartialName('Microsoft.VisualBasic') | Out-Null 
                    $global:ComputerName = [Microsoft.VisualBasic.Interaction]::InputBox("Enter the server name like AZVM01")
